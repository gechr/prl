...
const (
	...
	tuiHelpApprovePRs          = "Approve PRs"
	tuiHelpApproveMergePRs     = "Approve/Merge PRs"
	tuiHelpApproveNoConfirm    = "Approve PRs (no confirm)"
	tuiHelpClose               = "close"
	tuiHelpClosePRs            = "Close PRs"
	tuiHelpComment             = "comment"
	tuiHelpCopilotReview       = "Request Copilot review"
	tuiHelpCycleSortOrder      = "Cycle sort order"
	tuiHelpDiff                = "diff"
	tuiHelpDismiss             = "dismiss"
	tuiHelpExtendSelection     = "Extend selection"
	tuiHelpFilter              = "filter"
	tuiHelpForceMergePRs       = "Force-merge PRs"
	tuiHelpHelp                = "help"
	tuiHelpInvertSelection     = "Invert selection"
	tuiHelpJumpFirstLast       = "Jump to first/last"
	tuiHelpLaunchReview        = "Launch Claude review"
	tuiHelpLaunchReviewNoConf  = "Launch Claude review (no confirm)"
	tuiHelpMerge               = "merge"
	tuiHelpMergePRs            = "Merge PRs"
	tuiHelpNavigate            = "Navigate up/down"
	tuiHelpNext                = "next"
	tuiHelpOpen                = "open"
	tuiHelpOpenInBrowser       = "Open in browser"
	tuiHelpOptions             = "options"
	tuiHelpPrev                = "prev"
	tuiHelpQuit                = "Quit"
	tuiHelpReopen              = "reopen"
	tuiHelpReopenPRs           = "Reopen PRs"
	tuiHelpReview              = "review"
	tuiHelpScroll              = "scroll"
	tuiHelpSelect              = "select"
	tuiHelpSelectAllNone       = "Select all/none"
	tuiHelpSendToSlack         = "Send to Slack"
	tuiHelpSendToSlackNoConf   = "Send to Slack (no confirm)"
	tuiHelpShow                = "show"
	tuiHelpShowPRDetail        = "Show PR detail"
	tuiHelpSlack               = "slack"
	tuiHelpToggleAutoRefresh   = "Toggle auto-refresh"
	tuiHelpToggleHelp          = "Toggle this help"
	tuiHelpToggleSelection     = "Toggle selection"
	tuiHelpUnassign            = "Unassign/unsubscribe"
	tuiHelpUnassignNoConfirm   = "Unassign (no confirm)"
	tuiHelpUnsubscribe         = "unsubscribe"
	tuiHelpUpdateBranch        = "update branch"
	tuiHelpUpdateBranchOverlay = "Update branch"
	tuiHelpViewDiff            = "View diff"
)
