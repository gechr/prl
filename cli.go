...
type CLI struct {
	...
	Comments        string   `name:"comments"    help:"Filter by comment count (>5, 10..20)"                                                                                   placeholder:"<range>"              clib:"terse='Comment count',group='Filters/4'"`
	...
	Version bool   `name:"version" help:"Print version"                              short:"V" clib:"terse='Version',group='Miscellaneous/2'"`
