...
type CLI struct {
	...
	Columns  CSVFlag `help:"Table columns [index, ref, repo, owner, number, title, labels, author, state, created, updated, url]"           clib:"terse='Table columns',complete='predictor=columns,comma',group='Output/1'"                                                                                                 aliases:"col" placeholder:"<cols>"`
